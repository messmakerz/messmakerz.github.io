  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ position: "relative", width: 1, height: 36, overflow: "hidden" }} className="md:[height:52px]">
      ...
      {/* Content */}
      <div className="relative z-10 px-6 md:px-14 lg:px-20 pt-28 md:pt-36 pb-24 md:pb-20">
